...
<div class="login-page">
  <div class="form">
    ...
    <form class="login-form" action="insertar" method="POST">
        <h2><i class="fas fa-lock"></i> Registrarse</h2>
...
<br>
        ...
        <p class="message">Ya estas registrado? <a href="http://localhost/citas/public/">Inicio</a></p>
    </form>
  </div>
</div>
